...
public class Type extends PositionableElement implements IUmlConnectionNode,
	...
	public Element toXml(Document doc){
		System.out.println("can read from toxml");
		...
		Text nameText = doc.createTextNode(getName());
		nameElement.appendChild(nameText);
		subRoot.appendChild(nameElement);

		Element stereoElement = doc.createElement("study");
		Text stereoText = doc.createTextNode(getStereotype());
		stereoElement.appendChild(stereoText);
		subRoot.appendChild(stereoElement);
		return subRoot;
	}
