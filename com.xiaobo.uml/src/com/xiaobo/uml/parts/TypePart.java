...
public class TypePart extends PositionableElementPart implements NodeEditPart {
	...
	public void activate() {
		if (!isActive()) {
			 ...
			 * 
			 * when we rewrite the {@link UmlModelPart#refreshChildren()},
			 * adding this TypePart as the PropertyChangeListener to the parent
			 * model isn't necessary.
			 */
			// ((UmlModel)
			// getParent().getModel()).addPropertyChangeListener(this);
			/**
